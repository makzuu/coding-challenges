...
void get_options(int argc, char *argv[], char *delimiter, list_t *options_list);
void get_files(int argc, char *argv[], list_t *files_list);
void process_options(char *delimiter, list_t *files_list, list_t *options_list);
...
int main(int argc, char *argv[]) {
    ...
    get_options(argc, argv, &delimiter, options_list);
    get_files(argc, argv, files_list);
    process_options(&delimiter, files_list, options_list);
